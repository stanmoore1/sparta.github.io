...
Tim Bartel (Sandia) was the chief author of the 2d `ICARUS DSMC code <https://sjplimp.github.io/dsmc.html>`_, a predecessor to
...
+-------+---------------------------------------------------+---------------------------------------------+
| Jul22 | surf\_collide adiabatic                           | Tim Teichmann (KIT)                         |
+-------+---------------------------------------------------+---------------------------------------------+
...
+-------+---------------------------------------------------+---------------------------------------------+
| Oct21 | surf\_react adsorb                                | Krishnan Gopalan (NASA Ames)                |
+-------+---------------------------------------------------+---------------------------------------------+
| Jan20 | surf\_collide cll, td, and impulsive models       | Krishnan Gopalan (NASA Ames)                |
+-------+---------------------------------------------------+---------------------------------------------+
